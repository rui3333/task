...
void setup(){
  ...
  button.addButton("flip").setPosition(700, 200);  
}
...
class Mole{
     PImage img=loadImage("mole.png");
     PImage img2=loadImage("mole_hit.png");
     int xpos, ypos, xp, yp;
     float interbaltime;
